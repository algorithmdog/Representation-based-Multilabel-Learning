...
mkdir -p result
mkdir -p result
name=wsabie_$1_b1_i2_l20.001_h$2

echo "" > result/$name.result
echo "" > result/$name.log

for((i=0;i<5;i++));do
python train_wsabie.py  -b 1 -i 2 -l2 0.001 -h $2  ~/multi_label_data/$1/svm_cv/$i/train-$i.arff result/$1.model.$i 2>> result/$name.log
